...
//     const [state, handleSubmit] = useForm("xleqbeba");
//     if (state.succeeded) {
...
//                                     <form className="flex flex-col space-y-2 text-[#000] justify-center" onSubmit={handleSubmit}>
//                                         <input
//                                             type="text"
...
//                                             errors={state.errors}
//                                         />
//                                         <button type="submit" className="btn bg-white text-blue-800 font-bold py-2 rounded hover:bg-blue-800 hover:text-white hover:border-0 text-base" disabled={state.submitting}>
//                                             Submit Enquiry
//                                         </button>
//                                     </form>
//                                 </div>
