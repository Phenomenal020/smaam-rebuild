                    ...
                    <div className="flex flex-col md:flex-row gap-8">
                        ...
                        <div className="flex flex-col md:px-4 md:w-[50%]">
                            ...
                            <div className="mb-2">
                                ...
                                <span className="align-middle ml-2 font-medium text-sm md:text-[15px]">Address</span>
                                <p className="mt-2 text-sm md:text-[15px]">No.4 Aliade Street Highlevel, Makurdi Benue State, Nigeria. Opposite Bishop Murray medical centre Highlevel Makurdi.</p>
                            </div>
                            <div className="mb-2">
                                <AiOutlineMail className="inline-block text-blue-600 text-2xl" />
                                <span className="align-middle ml-2 font-medium text-sm md:text-[15px]">Email</span>
                                <p className="mt-2 break-words text-sm md:text-[15px]">St.michaelthearchangelacademymakurdi2@gmail.com</p>
                            </div>
                            <div className="mb-2">
                                <AiOutlinePhone className="inline-block text-blue-600 text-2xl" />
                                <span className="align-middle ml-2 font-medium text-sm md:text-[15px]">Phone Number</span>
                                <p className="mt-2 text-sm md:text-[15px]">+234 (0) 806 9371 264, +234 (0) 704 4362 422</p>
                            </div>
                            <div>
                            <iframe
                        ...
                        <div className="md:flex mt-8 md:mt-0 md:w-[50%]">
                            <div className="bg-blue-800 text-white p-6 rounded-lg shadow-lg w-full">
